...
function corePresetIdsFromSource() {
  const src = readFileSync(CORE_COLOR_GRADING_SOURCE, "utf8");
...
test(
  "preset IDs stay in sync with packages/core/src/colorGrading.ts",
  { skip: !existsSync(CORE_COLOR_GRADING_SOURCE) && "core source unavailable in plugin bundle" },
  () => {
