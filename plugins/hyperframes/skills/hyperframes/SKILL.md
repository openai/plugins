...
description: >
  ...
  project instructions describe the video workflow.
...
| **Import Figma content** — assets, tokens, components, storyboards→reconstructed motion (REST/CLI); optional Figma connector/tooling for motion and shaders              | `/figma`                 |
