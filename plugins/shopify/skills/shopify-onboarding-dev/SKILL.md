...
compatibility: OpenAI Codex; Requires Node.js and Shopify CLI
metadata:
  author: Shopify
  version: "1.9.0"
---
...
**AI toolkit plugin/extension** — install for the detected client if needed:

| Client  | Install command                                |
| ------- | ---------------------------------------------- |
| `codex` | Already installed in Codex; continue to Step 3 |
| `other` | Send the user to https://shopify.dev/docs/apps/build/ai-toolkit for non-Codex install instructions, then stop |
