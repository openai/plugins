...
11. For concepted editorial, report, deck, generated-image, animation, scrollytelling, or existing-page integration work, use `../../references/foundations/meaning-preserving-visual-design-workflow.md` and `../../references/foundations/mobile-first-responsive-visualization.md`; do not begin implementation until the generated large-screen and mobile concept set has explicit user approval or a requested iteration has been resolved. After each generated concept set, show the large-screen and mobile portrait images plus mobile landscape when needed, summarize the TypeScript plan and interactions in concise bullets, ask for approval or specific changes, and iterate with revised concepts until the user agrees on the design. Model the approved concepts as a binding semantic design contract: user approval status, approved concept references, evidence lock, locked elements, flexible elements, data-bound layers, generated assets, label-safe regions, responsive states, motion states, fallbacks, and approved deviations.
...
- For concepted stories or figures before approval, show the generated large-screen and mobile portrait concepts plus mobile landscape when needed, concise implementation-plan bullets, concise interaction bullets, and an approval question before file edits or code generation. After approval, call out the user approval status, binding semantic design contract type, approved concept references, locked and flexible elements, data-bound layer contracts, generated asset metadata, mobile/landscape continuation, approved deviations, and semantic fidelity checks.
