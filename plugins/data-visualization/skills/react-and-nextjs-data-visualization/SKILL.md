...
12. For advanced editorial, report, deck, generated-image, animation, or existing-page integration work, use `../../references/foundations/meaning-preserving-visual-design-workflow.md` before implementation. If Codex image generation produces a layout, figure, page-integration, or key-frame concept, show the large-screen and mobile portrait concept images, plus mobile landscape when needed; summarize the React plan and interactions in concise bullets; and pause for explicit user approval or requested iteration before React implementation, file edits, or code generation begins. Iterate with revised concept sets until the user agrees on the design. React should implement the approved concepts as a binding semantic design contract, preserving locked layout, hierarchy, responsive continuation, interaction staging, and data-bound layers rather than reinterpreting the concept as decoration.
...
- For concepted surfaces before approval, show the generated large-screen and mobile portrait concepts, optional mobile landscape concept, concise React plan bullets, concise interaction bullets, and an approval question. After approval, name the user approval status, approved concept paths or screenshot references, binding semantic design contract, locked and flexible elements, data-bound React-owned layers, renderer-owned layers, mobile/landscape continuation, and approved deviations.
