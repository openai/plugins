...
- For concepted report, deck, or page layouts before approval, provide the concept images required by the surface: fixed-page/deck output concept, plus large-screen and mobile portrait concepts for browser/app delivery and mobile landscape when needed. Include concise layout-plan bullets, concise interaction or export-behavior bullets, and an approval question. After approval, provide the user approval status, approved concept paths or screenshot references, binding visual design contract, locked and flexible elements, data-bound layers, mobile/landscape or print continuation, approved deviations, and semantic fidelity QA checks.
