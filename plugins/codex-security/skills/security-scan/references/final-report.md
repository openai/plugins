...
- primary readable report at the final HTML scan report path from `../../../references/scan-artifacts.md`
- markdown report source used to generate the HTML report, at the final scan report path from `../../../references/scan-artifacts.md`
...
Generate the HTML report from the markdown report with:

`python3 <plugin_dir>/scripts/render_report_html.py --report-md <scan_dir>/report.md --report-html <scan_dir>/report.html --title "<repo_name> Codex Security Scan"`
